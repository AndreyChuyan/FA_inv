...
class Worker(Base):
    ...
    conn_worker_inventory= relationship("Inventory", back_populates="conn_inventory_worker")
...
class Inventory(Base):
    ...
    conn_inventory_worker= relationship("Worker", back_populates="conn_worker_inventory")
